...
public class P079_GraphicsDemo3 extends Canvas{
    public void paint( Graphics g )
    {
        ...
        g.drawLine(60,200,90,0);
        g.setColor(Color.blue);
        g.drawLine(50,150,100,180);
        g.setColor(Color.magenta);
        g.drawLine(100,350,300,230);
        g.setColor(new Color(190, 177, 255));
        g.drawLine(90,0,300,230);

        int style = Font.BOLD | Font.ITALIC;

        // fonts
        g.drawString("Graphics are pretty neat.", 500, 100);
        g.setFont(new Font("Arial", Font.PLAIN, 36)); // 36-pt plain
    ...
    public static void main( String[] args )
    {
        ...
        P079_GraphicsDemo3 canvas = new P079_GraphicsDemo3();
        win.add( canvas );
        win.setVisible(true);
    }
}
